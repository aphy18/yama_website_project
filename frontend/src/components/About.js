    ...
    <div id="about-us" className='w-full h-auto flex flex-col justify-evenly items-start relative'>
        <section id="first-section" className='xl:h-[65vh] lg:h-[100vh] h-[130vh] xl:flex lg:flex z-20 w-full items-center'>
          <div id="intro-paragraph" className='xl:w-1/2 xl:h-full lg:w-1/2 lg:h-full w-full h-3/5 text-[20px] flex flex-col justify-between items-center text-center font-medium bg-black opacity-[0.95] text-white overflow-hidden'>
            ...
            <p className='leading-[50px] xl:text-[18px] lg:text-[18px] text-[15px] h-1/2 px-16 text-justify font-normal mt-8'>Welcome to the YAMA Anime and Manga Association, a vibrant community committed to sharing our love of anime, manga, and beyond. Our mission is to create a friendly and inclusive atmosphere where like-minded fans may connect and share their passions. At YAMA, we take pleasure in providing a lively setting for our members through our wide variety of activities and events. Join YAMA today to make new friends and fun memories!</p>
        ...
        <section id="membership" className='flex lg:flex-row lg:justify-between flex-col first-section w-full h-[800px] items-center z-20'>
          <div className='w-full h-full flex flex-col xl:justify-end lg:justify-end justify-evenly items-center text-white bg-black opacity-[0.95] text-center'>
            <h1 className='w-full bounce xl:text-[70px] md:text-[50px] text-[35px] font-bold'>Receive Your Membership Today!</h1>
            <div className='flip-container relative xl:w-1/2 xl:h-[650px] lg:w-1/2 lg:h-[650px] w-full h-[500px]'>
        ...
        <div id="third-paragraph" className='w-full xl:h-[700px] lg:h-[700px] h-[1000px] xl:flex lg:flex xl:justify-between lg:justify-between justify-center items-center z-20'>
          <div id="register-paragraph" className='xl:w-1/2 lg:w-1/2 w-full xl:h-full lg:h-full h-1/2 flex justify-center items-center bg-tabling bg-cover relative'>
            <ul id="register-list" className='w-1/2 h-[400px] z-20 text-[18px] flex flex-col justify-evenly items-start list-disc relative font-bold px-8 lg:ml-4'>
