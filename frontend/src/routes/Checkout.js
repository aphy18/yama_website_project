...
const Checkout = () => {
  ...
  if (checkoutCart) {
    return (
      <>
        <div id="main-checkout-container" className='flex flex-col justify-start items-center w-full h-auto bg-yamabackground bg-cover p-10 relative'>
          <section className='big-container w-4/5 h-auto flex flex-col justify-around mt-20 bg-white z-20 px-8 border-[2px] border-solid border-orange-400 border-b-0 overflow-hidden overflow-x-scroll'>
            ...
            <div id="confirm-cart" className='flex flex justify-evenly items-center'>
