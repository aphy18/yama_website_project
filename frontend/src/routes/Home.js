  ...
  return (
    <div id="home-container" className='h-auto flex flex-col justify-start items-center'>
        <section id="clubphoto" className='border-2 border-solid border-cyan-500 w-full flex lg:flex-row lg:justify-start lg:items-center h-1/4 flex-col justify-center items-center bg-clubphoto bg-cover bg-center relative'>
          <div id="yama-welcome-container" className='border-2 border-green-500 border-solid z-20 flex flex-col lg:justify-center lg:items-start lg:w-auto lg:h-full lg:h-[50%] h-[70%] lg:mt-0 w-full justify-start items-center mt-20 mr-0'>
          ...
          <div id="york-logo-container" className='border-2 border-solid border-white w-[250px] h-full z-20 flex justify-start items-end '>
