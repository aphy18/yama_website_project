...
function Home() {
  return (
    <div id="home-container" className='w-full lg:h-[320vh] md:h-[400vh] max-h-auto flex flex-col justify-start items-center p-0'>
        <section id="clubphoto" className='w-full lg:h-2/5 flex lg:flex-row lg:justify-center lg:items-center h-1/4 flex-col justify-center items-center bg-clubphoto bg-cover bg-center relative'>
          ...
          <div className='h-auto z-20 flex justify-start items-end lg:translate-x-8 lg:w-[500px] lg:h-1/2 lg:order-last lg:scale-[2] w-[250px]'>
