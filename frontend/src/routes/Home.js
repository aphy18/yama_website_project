...
function Home() {
  return (
    <div className='w-full h-[320vh] max-h-auto flex flex-col justify-start items-center'>
        <section id="clubphoto" className='w-full h-2/5 flex lg:flex-row lg:justify-center lg:items-center flex-col justify-center items-center bg-clubphoto bg-cover bg-center relative'>
          <div className='z-20 flex flex-col lg:justify-center lg:items-start lg:w-auto lg:h-full lg:mr-8 h-[50%] w-full justify-start items-center border-2 border-solid border-red-500'>
          ...
          <div className='h-auto z-20 flex justify-start items-end lg:translate-x-8 lg:w-[500px] lg:h-1/2 lg:order-last lg:mb-0 lg:scale-[2] order-first w-[250px] mb-8 border-2 border-solid border-black'>
